      ...
      function (countryID) {
        ...
        countryElement.addEventListener(
          ...
          function (e) {
            ...
            var countrySites = countryElement.getAttribute('data-sites');
        ...
        if (
          ...
          this.options.data.values[countryID]['sites']
        ) {
          countryElement.setAttribute(
            'data-sites',
            this.options.data.values[countryID]['sites']
          );
          if (this.options.data.values[countryID]['sitesTarget']) {
            countryElement.setAttribute(
              'data-sites-target',
              this.options.data.values[countryID]['sitesTarget']
            );
          }
          ...
          const clickHandler = function (e) {
            ...
            const sites = countryElement.getAttribute('data-sites');
            const target = countryElement.getAttribute('data-sites-target');
